...
export const ChatInput = ({ value, onChange, onSubmit, isLoading, disabled }: ChatInputProps) => {
  ...
  return (
    <div className="relative flex items-end gap-2 rounded-2xl border border-border bg-card shadow-elevated px-4 py-3">
      <textarea
        ref={ref}
        rows={1}
        value={value}
